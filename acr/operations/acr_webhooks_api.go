...
func NewACRWebhooksAPI(spec *loads.Document) *ACRWebhooksAPI {
	return &ACRWebhooksAPI{
		...
		APIGetResultsHandler: apiops.GetResultsHandlerFunc(func(params apiops.GetResultsParams) middleware.Responder {
			return middleware.NotImplemented("operation api.GetResults has not yet been implemented")
		}),

		// Applies when the "api_key" query is set
		APIKeyAuth: func(token string) (*models.Principal, error) {
			return nil, errors.NotImplemented("api key auth (api_key) api_key from query param [api_key] has not yet been implemented")
		},
...
type ACRWebhooksAPI struct {
	...
	APIGetResultsHandler apiops.GetResultsHandler
...
func (o *ACRWebhooksAPI) Validate() error {
	...
	if o.APIGetResultsHandler == nil {
		unregistered = append(unregistered, "api.GetResultsHandler")
	}
...
func (o *ACRWebhooksAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/v1/results/{resultId}"] = apiops.NewGetResult(o.context, o.APIGetResultHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/results"] = apiops.NewGetResults(o.context, o.APIGetResultsHandler)
}
