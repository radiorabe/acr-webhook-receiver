...
func (o *GetResultURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/results/{resultId}"

	resultID := swag.FormatInt64(o.ResultID)
	if resultID != "" {
		_path = strings.Replace(_path, "{resultId}", resultID, -1)
	} else {
		return nil, errors.New("resultId is required on GetResultURL")
	}
