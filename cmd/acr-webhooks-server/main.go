...
func main() {
	...
	swaggerSpec, err := loads.Embedded(acr.SwaggerJSON, acr.FlatSwaggerJSON)
	if err != nil {
		log.Fatalln(err)
	}
	...
	parser.ShortDescription = "ACRCloud Webhooks Receiver"
	parser.LongDescription = "Hooks to receive ACRCloud events on and a simple API to query the received data.\nStores all data in a PostgreSQL database for later querying.\n"
